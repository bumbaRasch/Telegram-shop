...
async def edit_msg(message: Message, text: str, reply_markup=None, parse_mode: str = "HTML") -> None:
    """
...
async def edit_media_msg(
    message: Message, photo_path: str, caption: str, reply_markup=None, parse_mode: str = "HTML"
) -> None:
    """
