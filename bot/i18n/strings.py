...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "payments.cooldown": "⏳ Подождите ещё {seconds} сек. перед созданием нового инвойса.",
    ...
    "en": {
        ...
        "payments.cooldown": "⏳ Please wait {seconds} more second(s) before creating a new invoice.",
